...
class FastCore:
    def __init__(self, name, coreid, svc, reg, mem, sys):
        ...
        logging.info('FastCore.__init__(): self.mainmem.filename        : {}'.format(self.mainmem.get('filename')))
        logging.info('FastCore.__init__(): self.mainmem.capacity        : {}'.format(self.mainmem.get('capacity')))
...
if '__main__' == __name__:
    parser = argparse.ArgumentParser(description='Nebula: Fast Core')
...
#                state.update({'cycle': _restore.get('cycle')})
                ...
                logging.info('_mainmem.mmu.translations : {}'.format(_mainmem.mmu.translations))
                logging.info('_regile.registers : {}'.format(_regfile.registers))
