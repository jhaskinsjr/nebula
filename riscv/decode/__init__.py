...
def r_type(word):
    ...
    _cmds = {
        ...
        (0b000_0000, 0b001, 0b011_1011): 'SLLW',
        (0b000_0000, 0b101, 0b011_1011): 'SRLW',
        (0b010_0000, 0b101, 0b011_1011): 'SRAW',
...
def atomic(word):
    ...
    _variety = {
        ...
        (0b0_0001, 0b011): {'cmd': 'AMOSWAP.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b0_0000, 0b011): {'cmd': 'AMOADD.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b0_0100, 0b011): {'cmd': 'AMOXOR.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b0_1100, 0b011): {'cmd': 'AMOAND.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b0_1000, 0b011): {'cmd': 'AMOOR.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b1_0000, 0b011): {'cmd': 'AMOMIN.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b1_0100, 0b011): {'cmd': 'AMOMAX.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b1_1000, 0b011): {'cmd': 'AMOMINU.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
        (0b1_1100, 0b011): {'cmd': 'AMOMAXU.D', 'nbytes': 8, 'rs2': uncompressed_rs2(word)},
...
#        return []
    ...
    while max_insns > len(_retval) and len(buffer[x:4 + x]):
        if skip_nulls and 0 == int.from_bytes(buffer[x:2 + x], 'little'):
            x += 2
            continue
