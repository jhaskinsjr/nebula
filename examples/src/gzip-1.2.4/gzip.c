...
#undef  O_CREAT
#define O_CREAT 64 // O_CREAT on my native Linux system, but *NOT* my RISC-V C compiler
#undef  O_EXCL
#define O_EXCL 128 // O_EXCL on my native Linux system, but *NOT* my RISC-V C compiler
