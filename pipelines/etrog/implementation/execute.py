...
class Execute:
    ...
    def do_tick(self, results, events, **kwargs):
        ...
        logging.debug('Execute.do_tick(): {} {}'.format(results, events))
        for reg in map(lambda y: y.get('register'), filter(lambda x: x.get('register'), results)):
            if '%{}'.format(reg.get('name')) == self.get('operands').get('rs1'):
                self.get('operands').update({'rs1': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('rs2'):
                self.get('operands').update({'rs2': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_num'):
                self.get('operands').update({'syscall_num': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a0'):
                self.get('operands').update({'syscall_a0': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a1'):
                self.get('operands').update({'syscall_a1': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a2'):
                self.get('operands').update({'syscall_a2': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a3'):
                self.get('operands').update({'syscall_a3': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a4'):
                self.get('operands').update({'syscall_a4': reg.get('data')})
            elif '%{}'.format(reg.get('name')) == self.get('operands').get('syscall_a5'):
                self.get('operands').update({'syscall_a5': reg.get('data')})
        for mem in map(lambda y: y.get('mem'), filter(lambda x: x.get('mem'), results)):
            if mem.get('addr') != self.get('operands').get('mem'): continue
            self.get('operands').update({'mem': mem.get('data')})
        ...
        for execute in map(lambda y: y.get('execute'), filter(lambda x: x.get('execute'), events)):
            self.update({'pending_execute': execute.get('insn')})
        if self.get('pending_execute'): do_execute(self.service, self)
...
if '__main__' == __name__:
    ...
    state = Execute('execute', args.coreid, _launcher)
